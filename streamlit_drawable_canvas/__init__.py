...
def st_canvas(
    ...
    if background_image:
        ...
        # Streamlit removed the private image_to_url helper. Use a self-contained
        # data URI so the component works across supported Streamlit versions.
        buffer = BytesIO()
        background_image.convert("RGB").save(buffer, format="PNG", optimize=True)
        background_image_url = "data:image/png;base64," + base64.b64encode(buffer.getvalue()).decode("ascii")
        background_color = ""
